...
triggers: GitHub project, project management automation, issue tracking, board automation, sprint planning, kanban board, agile workflow, milestone tracking, project board sync
author: Claude Code
tags:
  - github
  - project-management
...
Claude should automatically activate **github-project-management** when:
- ✅ User mentions "GitHub project management" or "project board automation"
- ✅ User asks "how to manage GitHub issues" or "automate project boards"
- ✅ User needs "sprint planning", "kanban workflow", or "milestone tracking"
- ✅ User is organizing GitHub issues, creating project boards, or tracking progress
- ✅ User mentions "issue triage", "board sync", or "agile workflow"
- ✅ User wants to "coordinate team work" or "track sprint velocity"

Claude should **NOT** activate this skill for:
- ❌ Simple issue creation or PR management (use basic GitHub commands)
- ❌ Code review tasks (use github-code-review skill)
- ❌ Release management (use github-release-management skill)
- ❌ Repository setup or configuration without project management needs
...
### v1.0.0 (2025-10-24)
- Initial creation with comprehensive GitHub project management capabilities
- Swarm-coordinated issue tracking and project board automation
- Sprint planning and milestone management
- Automated triage and task decomposition with AI agents
