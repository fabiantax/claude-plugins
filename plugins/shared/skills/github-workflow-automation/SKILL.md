...
triggers: GitHub workflow, CI/CD automation, GitHub Actions, workflow orchestration, continuous integration, continuous deployment, repository management
...
Claude should automatically activate **github-workflow-automation** when:
- ✅ User mentions "GitHub Actions", "CI/CD workflow", or "GitHub workflow"
- ✅ User asks to "automate deployment", "setup CI", or "create pipeline"
- ✅ User needs to optimize existing GitHub Actions workflows
- ✅ User is setting up automated testing or continuous integration
- ✅ User wants to coordinate multi-repo workflows
- ✅ User requests workflow analysis or performance optimization

Claude should **NOT** activate this skill for:
- ❌ Creating pull requests manually (use gh CLI directly)
- ❌ Managing GitHub issues without workflow automation (use issue tracking)
- ❌ Manual Git operations (commit, push, merge)
- ❌ Code review without automation (use review tools)
- ❌ Simple repository cloning or setup (basic Git operations)
...
### v1.0.0 (2025-10-24)
- Initial creation with advanced GitHub Actions workflow automation
- AI swarm coordination for intelligent CI/CD pipelines
- 8 specialized GitHub integration modes (gh-coordinator, pr-manager, issue-tracker, etc.)
- Production-ready workflow templates (intelligent CI, multi-language detection, security scanning)
- Self-healing pipelines and progressive deployment strategies
- Comprehensive monitoring, analytics, and cost optimization
- Integration with Claude-Flow MCP tools and batch operations
---
