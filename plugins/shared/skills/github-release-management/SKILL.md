...
triggers: release coordination, version management, automated deployment, release automation, rollback management, release orchestration, GitHub releases, deployment automation, version control
category: github
...
Claude should automatically activate **github-release-management** when:
- ✅ User mentions "release coordination", "version management", or "automated deployment"
- ✅ User asks "how do I automate GitHub releases?"
- ✅ User needs changelog generation, artifact building, or multi-platform deployment
- ✅ User is preparing a software release with versioning and deployment automation
- ✅ User wants rollback management or comprehensive release orchestration

Claude should **NOT** activate this skill for:
- ❌ Simple git tagging (use standard git commands)
- ❌ Single-file deployments without versioning
- ❌ Pull request workflows (use github-workflow-automation instead)
- ❌ Issue tracking or project management (use github-project-management instead)
...
### v1.0.0 (2025-10-24)
- Initial creation with comprehensive GitHub release orchestration
- AI swarm coordination for automated versioning, testing, and deployment
- Rollback management and multi-environment deployment strategies
