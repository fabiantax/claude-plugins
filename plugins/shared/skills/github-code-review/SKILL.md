...
version: 1.0.0
description: "Comprehensive GitHub code review with AI-powered swarm coordination. Triggers: code review, PR review, automated review, code quality, pull request review, review automation, GitHub review, code analysis, quality assurance"
category: github
...
Claude should automatically activate **github-code-review** when:
- ✅ User mentions "review this PR", "code review automation", or "analyze pull request"
- ✅ User asks "how do I automate code reviews" or "review code quality on GitHub"
- ✅ User needs multi-agent code review with security, performance, and style analysis
- ✅ User wants to enforce quality gates or comprehensive PR reviews
- ✅ User is setting up automated review workflows for pull requests

Claude should **NOT** activate this skill for:
- ❌ Simple linting or formatting (use ESLint, Prettier, or similar tools)
- ❌ One-time manual code review without automation (use standard PR review process)
- ❌ Non-GitHub platforms like GitLab or Bitbucket (adapt patterns manually)
- ❌ Local code analysis without GitHub integration (use static analysis tools)
...
### v1.0.0 (2025-10-24)
- Initial creation with complete AI-powered code review system including multi-agent review swarm, specialized review agents (security, performance, architecture, style, accessibility), PR-based swarm management, automated workflows, and quality gate enforcement
