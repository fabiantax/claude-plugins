---
name: swarm-advanced
description: "Advanced swarm orchestration patterns for research, development, testing, and complex distributed workflows. Triggers: advanced swarm, swarm patterns, swarm optimization, multi-agent patterns, distributed execution, parallel coordination, swarm strategies, mesh topology, hierarchical topology"
version: 2.0.0
...
Claude should automatically activate **swarm-advanced** when:
- ✅ User mentions "advanced swarm patterns", "complex multi-agent workflows", or "distributed coordination"
- ✅ User asks "how do I optimize swarm topology" or "coordinate parallel research tasks"
- ✅ User needs mesh, hierarchical, ring, or star topology coordination strategies
- ✅ User is building complex distributed systems with 5+ agents or parallel execution
- ✅ User wants adaptive strategies, custom coordination patterns, or research-heavy workflows

Claude should **NOT** activate this skill for:
- ❌ Simple single-agent tasks (use standard agent execution)
- ❌ Basic swarm setup with 2-3 agents (use swarm-orchestration skill instead)
- ❌ Sequential workflows without parallelization (use standard task execution)
- ❌ Performance analysis (use performance-analysis skill instead)
...
### v2.0.0 (2025-10-24)
- Initial creation with advanced swarm orchestration patterns
- Support for 4 topologies: mesh, hierarchical, ring, star
- Research, development, testing, and analysis swarm patterns
- Error handling and fault tolerance
- Memory and state management
- Neural pattern learning
- Workflow automation
- Performance optimization and monitoring
- Real-world examples for AI research, full-stack apps, security audits
